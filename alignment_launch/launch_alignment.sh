...
test_outdir=${outdir}/wgs_full_test
## make tmp dir
tmpdir=/data1/shahs3/users/preskaa/tmp
mkdir -p ${tmpdir}
###
sif_path=/data1/shahs3/users/preskaa/singularity/wgs_alignment_v240531.sif
input_yaml=${HOME}/wgs/alignment_launch/APS017_PDX_test_inputs.yaml
context_yaml=${HOME}/wgs/alignment_launch/APS017_PDX_test_context_config.yaml
